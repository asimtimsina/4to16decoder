...
HD_PWD='C:/Users/14693/lab2_Asim/lab2_Asim.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log decoder4to16.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source decoder4to16.tcl -notrace
