...
HD_PWD='C:/Users/14693/lab2_Asim/lab2_Asim.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log decoder4to16.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source decoder4to16.tcl
